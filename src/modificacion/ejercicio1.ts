...
// Ahora creamos las subclases que heredan de la clase abstracta

/**
 * Clase que hereda de la clase abstracta MyMapReduce
 */
export class AddMapReduce extends MyMapReduce {

  /**
   * Método que aplica el reduce a cada elemento del array
   * @param array array de números
 ...
 * Clase que hereda de la clase abstracta MyMapReduce
 */
export class ProdMapReduce extends MyMapReduce {
 ...
 * Clase que hereda de la clase abstracta MyMapReduce
 */
export class DivMapReduce extends MyMapReduce {
